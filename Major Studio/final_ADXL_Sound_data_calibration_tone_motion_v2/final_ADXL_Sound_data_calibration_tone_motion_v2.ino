...
int min_x; //Minimum x Value
int max_x; //Maximum x Value
int xVal; //Current x Value

int min_y; //Minimum y Value
int max_y; //Maximum y Value
int yVal; //Current y Value

int min_z; //Minimum z Value
int max_z; //Maximum z Value
...
int tolerance=20; // Sensitivity of the motion
...
{ 
  ...
  if(y >(max_y+tolerance) || y < (min_y-tolerance)){
    Serial.println("yMove");
    digitalWrite(redLEDpin, HIGH);  // Error light
  }

  if(z >(max_z+tolerance) || z < (min_z-tolerance)){
